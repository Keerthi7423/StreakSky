...
class HabitCard extends ConsumerStatefulWidget {
  ...
  const HabitCard({super.key, required this.habit, this.isCompleted = false});
...
class _HabitCardState extends ConsumerState<HabitCard>
  ...
  Widget build(BuildContext context) {
    final themeColor = Color(
      int.parse('0xFF${widget.habit.colorHex ?? "B3FF00"}'),
    );
    ...
    return Semantics(
      label:
          'Habit: ${widget.habit.name}, Status: ${isCompleted ? "Completed" : "Incomplete"}',
                      ...
                      children: [
                        ...
                        streakAsync.when(
                          data: (streak) {
                            ...
                            final milestone = StreakMilestone.fromDays(
