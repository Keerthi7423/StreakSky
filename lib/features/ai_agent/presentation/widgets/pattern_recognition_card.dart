...
class PatternRecognitionCard extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PatternRecognitionCard> createState() =>
      _PatternRecognitionCardState();
}

class _PatternRecognitionCardState
    extends ConsumerState<PatternRecognitionCard> {
  String? _analysis;
  ...
  void _analyze() async {
    ...
    const historicalData =
        "Habit A: 80% completion, Habit B: 40% completion. Misses on weekends.";
